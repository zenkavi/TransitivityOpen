...
render_this <- function(){rmarkdown::render('Transitivity_OpenDataOrganization.Rmd', output_dir = '/Users/zeynepenkavi/Dropbox/CDSPart1/TransitivityOpen/', html_notebook(toc = T, toc_float = T, code_folding = 'hide'))}
